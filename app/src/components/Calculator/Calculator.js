...
class Calculator extends Component {
    ...
    clearDisplay(){
      this.setState({display: '0', temp: 0, resetDisplay: false, operator: ''})
    }
  ...
  render(){
   ...
   <div id="calculator-mask" className="remove-highlight">
     ...
     <div className="btn clear" onClick={() => {this.clearDisplay('display')}}></div>
     ...
     <div className="btn equal" onClick={() => {this.calculate('result')}}></div>
